    ...
    public partial class Functions
    {
        ...
        private void Hash(string path)
        {
            using(var stream = new FileStream(path, FileMode.Open))
            {
                ...
                WriteLine($@"#pragma checksum ""{path}"" ""{{406ea660-64cf-4c82-b6f0-42d48172a799}}"" ""{hashstr}""");
            }
        }
        ...
        public void WriteInterfaces(IList<ResourceRootNode> tree)
        {
            ...
            WriteLine(indent, $@"[global::System.Diagnostics.DebuggerDisplay(""[{{key,nq}}] = {{Value}}"")]");
            WriteLine(indent, $"{Properties.Modifier} struct {Properties.GRPName} : {Properties.IRPFullName}");
            WriteLine(indent, $"{{");
